...
public class ModbusTransportException extends Exception {
	...
	private final String InvalidFunctionCode = "01";
	private final String InvalidAddressCode = "02";
	private final String InvalidDataTypeCode = "03";
	private final String InvalidSlaveCode = "04";

	private final String InvalidCommitCode = "05";
	private final String SlaveBusinessCode = "06";
	private final String CRCFailCode = "08";

	private final String InternetCode = "08";
