...
/**
 * Used by slave implementors. Provides an interface by which slaves can easily
 * manage data.
 * 
 * @author mlohbihler
 */
public interface ProcessImage {
	...
	/**
	 * Used to set the holding register as a result of a write command from the
	 * master.
	 * 
	 * @param offset
	 * @param value
