...
public class MasterTest {
	public static void main(String[] args) throws Exception {
		...
		ModbusMaster master1 = modbusFactory.createRtuMaster(serialParameters);
		// ModbusMaster master =
		// modbusFactory.createAsciiMaster(serialParameters);
		...
		try {
			...
			// writeRegistersTest(master, slaveId, 0, new short[] {(short)65535,
			// 1000, 100, 10, 1});
			readHoldingRegistersTest(master, slaveId, 1, 2);
			...
			// writeCoilsTest(master, slaveId, 50, new boolean[] {true, false,
			// false, true, false});
			// writeCoilsTest(master, slaveId, 115, new boolean[] {true, false,
			// false, true, false});
			// writeRegistersTest(master, slaveId, 300, new short[] {1, 10, 100,
			// 1000, 10000, (short)65535});
			// writeRegistersTest(master, slaveId, 21, new short[] {1, 10, 100,
			// 1000, 10000, (short)65535});
			...
			// readExceptionStatusTest(master, slaveId);
			// reportSlaveIdTest(master, slaveId);
			// writeCoilsTest(master, slaveId, 11, new boolean[] {false, true,
			// false, false, true});
			// writeCoilsTest(master, slaveId, 10, new boolean[] {false, true,
			// false, false, true});

			// writeRegistersTest(master, slaveId, 10, new short[]
			// {(short)65535, 1000, 100, 10, 1});
			...
			// ModbusLocator locator = new ModbusLocator(slaveId,
			// RegisterRange.HOLDING_REGISTER, 15, (byte)2);
			...
			// batch.addLocator("hr1", new ModbusLocator(31,
			// RegisterRange.HOLDING_REGISTER, 80,
			// DataType.TWO_BYTE_BCD));
			// batch.addLocator("hr2", new ModbusLocator(31,
			// RegisterRange.HOLDING_REGISTER, 81,
			...
			// ModbusLocator locator = new ModbusLocator(slaveId,
			// RegisterRange.HOLDING_REGISTER, 50,
