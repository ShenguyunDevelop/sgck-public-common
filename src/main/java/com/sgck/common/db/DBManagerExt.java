...
public class DBManagerExt
{
	...
	private static DBManagerExt instance = new DBManagerExt();
	...
	public static DBManagerExt getInstance()
	{
		return new DBManagerExt();
	}
	...
	public  static void testAtomic(final int orgId)
	{
		try
		{
				DBManagerExt.getInstance().modify(new DBManagerAtomic() {
	...
	public final Connection getConnection() throws SQLException, NamingException
	{
		...
		if (!useJNDI)
		{
			return DBPoolExt.getInstance().getConnection();
		}
		}
		catch (Exception e)
		{
...
//				{
//
//					conn = DBPoolExt.getInstance().getConnection();
//				}
//
