...
public class DBPoolExt
{
	...
	private static DBPoolExt instance;
	...
	public static void initConfig(String driver,String url,String name,String pwd){
		DBPoolExt._driver_class = driver;
		DBPoolExt._URL = url;
		DBPoolExt._USER_NAME = name;
		DBPoolExt._PASSWORD = pwd;
	}
	
	public static synchronized DBPoolExt getInstance()
	{
		if (instance == null)
		{
			TimeZone.setDefault(TimeZone.getTimeZone("UTC"));
			instance = new DBPoolExt();
			try {
				instance.init();
			} catch (Exception e) {
